      ...
      <table class="w-full border-collapse">
        <thead class="bg-slate-50 border-b border-slate-200">
          <tr class="text-left text-sm text-slate-600">
            ...
            <th class="px-4 py-3 border-r border-slate-200">Status Pengajuan</th>
        ...
        <tbody class="text-sm text-slate-700 divide-y divide-slate-200">
          ...
          <tr class="hover:bg-slate-50 transition">
            <td class="px-4 py-3 font-medium">{{ $kelas ['matkul'] }}</td>
            <td class="px-4 py-3">{{ $kelas ['nama_kelas'] }}</td>
            <td class="px-4 py-3">{{ $kelas ['dosen_pengampu']}}</td>
            <td class="px-4 py-3">{{ $kelas ['semester'] }}</td>
            <td class="px-4 py-3">{{ $kelas ['kelas_terisi'] }} / {{ $kelas ['kelas_tersedia']}}</td>
            <td class="px-4 py-3">
...
<span class="px-2 py-1 text-xs rounded-md {{ $statusClass }}">
    {{ $status }}
</span>
      ...
      <table class="w-full border-collapse">
        ...
        <tbody class="divide-y divide-slate-200 text-sm">
          <tr class="hover:bg-slate-50">
            <td class="px-4 py-3 font-medium">P Web</td>
