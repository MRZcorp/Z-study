    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-sm text-white">NIM: 202201234</p>
          <p class="text-sm text-white">Fakultas Teknik · Informatika</p>
        </div>
      </div>
...
<p class="font-semibold text-white text-lg">4Budi Yono</p>
</div>
