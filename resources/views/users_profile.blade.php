...
<div x-data="{ photoPreview: null }"
  ...
  <div class="flex flex-col items-center text-center">
    ...
    <label class="relative cursor-pointer group">
      <img
        :src="photoPreview ? photoPreview : '/img/zaky.jpeg'"
...
<div class="flex justify-between items-center mb-4">
 ...
 <div>
   ...
   <template x-if="!edit">
     <p class="text-gray-700 mt-1">M. Zaky Nugraha A R</p>
   </template>
   <template x-if="edit">
     <input type="text"
 ...
 <div>
   ...
   <template x-if="!edit">
     <p class="text-gray-700 mt-1">zaky@kampus.ac.id</p>
   </template>
   <template x-if="edit">
     <input type="email"
            class="w-full rounded-lg border-gray-300
 ...
 <div>
   ...
   <template x-if="!edit">
     <p class="text-gray-700 mt-1">081234567890</p>
   </template>
   <template x-if="edit">
     <input type="text"
            class="w-full rounded-lg border-gray-300
      ...
      Biodata
        ...
        <div class="bg-white rounded-2xl shadow p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <p><span class="font-medium">Program Studi:</span> Teknik Informatika</p>
            <p><span class="font-medium">Jenjang:</span> S1</p>
            <p><span class="font-medium">Angkatan:</span> 2021</p>
        ...
        <div class="bg-white rounded-2xl shadow p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <p><span class="font-medium">Role:</span> Mahasiswa</p>
